...
prefixes = [
    ...
    "Must Read", "Urgent", "Scandal", "Truth", "Explosive"
]
emojis = ["🚨","🔥","⚡","💥","⚠️","📰","💣"]
...
def advanced_rephrase_specific(headline, reason, impact):
    ...
    # Expand short headlines
    if len(new_title) < 200:
        extra = f" | {reason_text}. यह विकास महत्वपूर्ण है और संबंधित पक्षों पर प्रभाव डाल सकता है। "
        new_title += extra
        if impact_text:
            new_title += f"{impact_text}।"
